        ...
        <div className="relative bg-card/95 backdrop-blur-xl border border-border/50 rounded-xl p-4 md:p-6 shadow-2xl">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
            ...
            <div className="flex items-center gap-3 w-full md:w-auto flex-shrink-0">
              <Button variant="outline" size="sm" onClick={handleDecline} className="flex-1 md:flex-none border-border/50">
                Decline
              </Button>
              <Button size="sm" onClick={handleAccept} className="flex-1 md:flex-none bg-primary text-primary-foreground hover:bg-primary/90">
                Accept All
              </Button>
            </div>
          </div>
