  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center bg-gradient-to-b from-foreground via-foreground/95 to-background">
        ...
        {/* Gradient Orbs */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/30 rounded-full blur-[150px] animate-pulse-soft" />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-secondary/20 rounded-full blur-[120px] animate-pulse-soft" style={{ animationDelay: '1s' }} />

        <div className="container relative z-10 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center gap-2 rounded-full bg-primary/10 border border-primary/30 px-4 py-2 text-sm font-medium text-primary mb-8 animate-fade-in backdrop-blur-sm">
                <Leaf className="h-4 w-4" />
                <span>India's Premier Carbon Platform</span>
              </div>
              
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold font-display tracking-tight mb-6 animate-slide-up text-primary-foreground">
                The Future of
                <span className="block mt-2 bg-gradient-to-r from-primary via-emerald-400 to-teal-400 bg-clip-text text-transparent">
                  Carbon Intelligence
                </span>
              </h1>
              
              <p className="text-lg lg:text-xl text-primary-foreground/70 mb-10 max-w-xl animate-slide-up mx-auto lg:mx-0" style={{ animationDelay: "0.1s" }}>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group relative p-6 rounded-2xl bg-card border border-border hover:border-transparent transition-all duration-500 overflow-hidden"
              >
